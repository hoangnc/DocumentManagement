...
{
    public static class DTWebConsts
    {
        public const string LocalizationSourceName = "DTWeb";
    }
    ...
    public static class ValidatorNames
    {
        ...
        public const string MaxLengthValidator = "MaxLengthValidator";
        public const string MinLengthValidator = "MinLengthValidator";
        ...
        public const string EnumNameValidator = "EnumNameValidator";
